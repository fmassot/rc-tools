...
class ANMappingTest(unittest.TestCase):
    def test_amendement_1(self):
        ...
        self.assertEquals(
            u"<p>I.- Rédiger ainsi les alinéas 4 et 5 :</p><p>« B. – Après l'article 1407 bis,il est inséré un article 1407 ter ainsi rédigé :</p><p>« Art. 1407 ter – Dans les communes classées dans les zones géographiques mentionnées au premier alinéa du I de l'article 232, pour la taxe d'habitation due au titre des logements meublés non affectés à l'habitation principale, le conseil municipal peut, par une délibération prise dans les conditions prévues à l'article 1639 Abis, majorer son taux de taxe d'habitation dans la limite de 20 %. Cette majoration n'est pas prise en compte pour l'application des articles 1636 Bsexies et 1636 Bdecies. ».</p><p>II. – En conséquence, à l'alinéa 11, substituer aux mots :</p><p>« au 4 du I de l'article 1636 B sexies »,</p><p>les mots :</p><p>« à l'article 1407 ter ».</p>",
            amendement.texte
        )
        self.assertEquals(
        ...
        self.assertEquals("fe1128143daa7e6869323485aee7bb6b", amendement.content_md5)
        """
