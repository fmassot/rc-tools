...
from nossenateurs.senpy.parsing.question_search_result_parser import parse_question_search_result


def test_parsing():
    html = codecs.open('test/test_nossenateurs/resources/question_search_result.html', encoding='iso-8859-1')
