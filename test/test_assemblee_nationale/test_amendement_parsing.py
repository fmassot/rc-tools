...
class AmendementParsingTest(unittest.TestCase):
    ...
    def test_html_parsing(self):
        ...
        expected_result = {
            ...
            u'expose': u'<p>La pr\xe9sente proposition de loi souhaite permettre la d\xe9ch\xe9ance de nationalit\xe9 \xe0 toute personne portant les armes contre les forces arm\xe9es fran\xe7aises et de police, ou leurs alli\xe9s.</p>\n<p>Actuellement la loi pr\xe9voit d\xe9j\xe0 la possible de d\xe9choir de leur nationalit\xe9 fran\xe7aise les personnes condamn\xe9e<span>s</span> pour un crime ou d\xe9lit constituant une atteinte aux int\xe9r\xeats fondamentaux de la nation et les personnes condamn\xe9es, en France ou \xe0 l\'\xe9tranger, pour crime \xe0 au moins cinq ann\xe9es d\'emprisonnement.</p>\n<p>Au-del\xe0 de son affichage, la pr\xe9sente proposition de loi ne couvrirait pas de cas nouveaux. Elle vise surtout \xe0 supprimer des garanties essentielles.</p>\n<p>Comme le propose le rapporteur, l\u2019avis du Conseil d\u2019Etat resterait syst\xe9matique, mais il ne serait plus obligatoirement suivi. C\u2019est pourtant une garantie fondamentale. La garantie temporelle pr\xe9vu \xe0 l\u2019article 25-1 du code civil serait \xe9galement abrog\xe9e.</p>\n<p>Il est \xe0 noter que la proposition de loi vise les personnes ayant acquis la nationalit\xe9 fran\xe7aise. Il est pourtant dangereux de consid\xe9rer qu\u2019il y aurait plusieurs cat\xe9gories de citoyens.</p>\n<p>Les r\xe9centes affaires montrent \xe9galement que le probl\xe8me de \xab\xa0djihaddistes fran\xe7ais\xa0\xbb n\u2019est pas un probl\xe8me de binationaux, ou de personnes qui auraient acquis la nationalit\xe9 fran\xe7aise.</p>\n<p>Pour toutes ces raisons, il est propos\xe9 de supprimer l\u2019article unique de cette loi.</p>',
